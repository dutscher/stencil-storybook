export const initCurrentScriptPolyfill = () => {
    ...
    Object.defineProperty(document, currentScript, {
      ...
      get: () => {
        ...
        try {
          ...
          const filteredScriptsWithCurrentScript = scripts.filter((script) => script.innerHTML.indexOf('document.currentScript') !== -1 && script.getAttribute('returned') === null);
